<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
			<a href="index.html">
				...
				<span>hatr-ı Stüdyo</span>
			</a>
		</div><!-- logo -->
		<div class="simple-page-form animated flipInY" id="login-form">
	<h4 class="form-title m-b-xl text-center">Yönetim Paneline Giriş Yapın</h4>
	<form action="<?php echo base_url("userop/do_login"); ?>" method="post">
		<div class="form-group">
			<input id="sign-in-email" type="email" value="<?php echo isset($form_error) ? set_value("user_email") : ""; ?>" class="form-control" placeholder="E-posta" name="user_email">
