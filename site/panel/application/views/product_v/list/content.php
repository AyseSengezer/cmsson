        ...
        <div class="widget p-lg">
            ...
            <?php if (empty($items)) { ?>
                ...
                <div class="alert alert-info text-center">
                    <p>Burda herhangi bir veri bulunmamaktadır. Eklemek için lütfen <a href="<?php echo base_url("product/new_form") ?>">tıklayınız...</a></p>
                </div>
            <?php } else { ?>
                    ...
                    <tbody class="sortable" data-url="<?php echo base_url("product/rankSetter"); ?>">
                        ...
                        <?php foreach ($items as $item) { ?>
                            ...
                            <tr id="ord-<?php echo $item->id; ?>">
                                ...
                                <td>
                                    <input data-url="<?php echo base_url("product/isActiveSetter/$item->id"); ?>" style="display: none;" class="isActive" type="checkbox" data-switchery data-color="#10c469" <?php echo ($item->isActive) ? "checked" : ""; ?> />
                                <td>
