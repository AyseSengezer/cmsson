<?php $galleries = image_home_list();
// print_r($galleries);
?>

<section class="main-container hidden">
    <div class="container">
        <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="image-box shadow text-center mb-20 ">
                                <div class="overlay-container overlay-visible ">
                                    ...
                                    <a href="<?php echo base_url("anasayfa-galerisi/$gallery->url"); ?>" class="overlay-link"><i class="fa fa-link"></i></a>
