                    ...
                    <div class="col-lg-6">
                        <div class="footer-content">
                            ...
                            <ul class="list-inline mb-20">
                                ...
                                <li class="list-inline-item"><a href="mailto:info@theproject.com" class="link-dark"><i class="text-default fa fa-envelope-o pr-1"></i><?php echo $settings->email; ?></a></li>
                            </ul>
    ...
    <div class="subfooter">
        <div class="container">
            <div class="subfooter-inner">
                <div class="row">
                    <div class="col-md-12">
                        <p class="text-center">Tüm Hakları Saklıdır © <?php echo date("Y"); ?> CMS by aySengezer. </p>
                    </div>
                </div>
            </div>
        </div>
