                        ...
                        <div class="footer-content">
                            ...
                            <?php echo character_limiter(strip_tags($settings->about_us), 150); ?>
                                <a href="<?php echo base_url("hakkimizda"); ?>">
                                    <i class="fa fa-long-arrow-right pl-5"></i></a></p>
    ...
    <div class="subfooter">
        <div class="container">
            <div class="subfooter-inner">
                <div class="row">
                    <div class="col-md-12">
                        <p class="text-center">Tüm hakları saklıdır © <?php echo date("Y") . " " . $settings->company_name; ?> | <a target="_blank" href="http://www.gokhankandemir.com">aSengezer</a></p>
                    </div>
                </div>
            </div>
        </div>
